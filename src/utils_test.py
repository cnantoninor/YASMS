...
test_data__data_uploaded_path: Path = (
    test_mdlc_data_path / "spam_classifier/test_model/test_project/DATA_UPLOADED"
)
test_data__training_in_progress_path: Path = (
    test_mdlc_data_path / "spam_classifier/test_model/test_project/TRAINING_IN_PROGRESS"
)
...
test_data__training_failed_path: Path = (
    test_mdlc_data_path / "spam_classifier/test_model/test_project/TRAINING_FAILED"
)
